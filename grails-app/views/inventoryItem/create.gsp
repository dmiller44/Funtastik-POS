...
<body>
<a href="#create-inventoryItem" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="create-inventoryItem" class="content scaffold-create" role="main">

...
<div id="show-department" class="content scaffold-show" role="main">
    ...
    <ol class="property-list department">
        ...
        <g:if test="${departmentInstance?.retired}">
            <li class="fieldcontain">
                <span id="retired-label" class="property-label"><g:message code="department.retired.label"
                                                                           default="Retired"/></span>

                <span class="property-value" aria-labelledby="retired-label"><g:formatBoolean
                        boolean="${departmentInstance?.retired}"/></span>
    ...
    <g:form>
        <fieldset class="buttons">
            ...
            <g:link class="edit" action="edit" id="${departmentInstance?.id}"><g:message

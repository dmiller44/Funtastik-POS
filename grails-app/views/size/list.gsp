...
<body>
<a href="#list-size" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="list-size" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <th><g:message code="size.itemType.label" default="Item Type"/></th>
        ...
        <g:each in="${sizeInstanceList}" status="i" var="sizeInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td>${fieldValue(bean: sizeInstance, field: "itemType")}</td>

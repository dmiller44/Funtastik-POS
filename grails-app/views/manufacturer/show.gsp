...
<div id="show-manufacturer" class="content scaffold-show" role="main">
    ...
    <ol class="property-list manufacturer">
        ...
        <g:if test="${manufacturerInstance?.phoneNumber}">
            <li class="fieldcontain">
                <span id="phoneNumber-label" class="property-label"><g:message code="manufacturer.phoneNumber.label"
                                                                               default="Phone Number"/></span>

                <span class="property-value" aria-labelledby="phoneNumber-label"><g:fieldValue
                        bean="${manufacturerInstance}" field="phoneNumber"/></span>
        ...
        <g:if test="${manufacturerInstance?.webSite}">
            <li class="fieldcontain">
                <span id="webSite-label" class="property-label"><g:message code="manufacturer.webSite.label"
                                                                           default="Web Site"/></span>

                <span class="property-value" aria-labelledby="webSite-label"><g:fieldValue
                        bean="${manufacturerInstance}" field="webSite"/></span>

            </li>
        </g:if>

        <g:if test="${manufacturerInstance?.preferredVendor}">
            <li class="fieldcontain">
                <span id="preferredVendor-label" class="property-label"><g:message
                        code="manufacturer.preferredVendor.label" default="Preferred Vendor"/></span>

                <span class="property-value" aria-labelledby="preferredVendor-label"><g:formatBoolean
                        boolean="${manufacturerInstance?.preferredVendor}"/></span>

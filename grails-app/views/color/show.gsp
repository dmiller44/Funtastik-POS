...
<body>
<a href="#show-color" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="show-color" class="content scaffold-show" role="main">
    ...
    <ol class="property-list color">
        ...
        <g:if test="${colorInstance?.name}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${colorInstance}"
                                                                                        field="name"/></span>
    ...
    <g:form>
        <fieldset class="buttons">
            ...
            <g:link class="edit" action="edit" id="${colorInstance?.id}"><g:message code="default.button.edit.label"
                                                                                    default="Edit"/></g:link>
